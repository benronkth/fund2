...
/**
 * Class containing the two static method to build and test a commit from its branch and hash.
...
public class Tasks {
     ...
     * @return Integer: the exit value of the series of tasks executions. As {@link Task#execute()},
     * 0 indicates normal termination, -1 exception, and any other integer the code of an error
     * that occurred.
     */
    ...
    /**
     * Iterate through a list of Tasks and execute them in order. The iteration stops and the method
     * returns in case an error occurs or an exception is caught.
     *
     * @param tasks A list of Task instances, can be seen as a list of console commands to execute
     * @return Integer: the exit value of the series of tasks executions. As {@link Task#execute()},
     * 0 indicates normal termination, -1 exception, and any other integer the code of an error
     * that occurred.
     */
